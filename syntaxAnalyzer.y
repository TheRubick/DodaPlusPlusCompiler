...
expression_statment_lv0: Identifiers '=' expression_statment {$$ = opr('=',2,arg($1),$3); 
                        ...
                        if(symbolTable.idenExp)
                        {
                            ...
                            if(!symbolTable.checkIdentifiersType($1,symbolTable.secondidentifier))
                            {
